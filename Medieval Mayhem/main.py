...
pygame.display.set_caption("Medieval Mayhem") # name displayed atop game window
...
pygame.mixer.music.load("../Medieval Mayhem/assets/audio/music.mp3")
pygame.mixer.music.set_volume(0.5)
pygame.mixer.music.play(-1 , 0.0, 5000)
sword_fx = pygame.mixer.Sound("../Medieval Mayhem/assets/audio/sword.wav")
